-- Fix verified seller filter: the boost migration (20260819030000) accidentally
-- collapsed the condition to `u.role = 'seller'` alone. Restore the original
-- semantics: only sellers with phone OR Fayda verification match.
